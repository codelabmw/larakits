...
export default function Terms() {
    ...
    useOnce(function () {
        sendPageView('terms', 'Larakits - Terms of Service');
    });
            ...
            <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 md:px-8">
                <div className="lg:flex lg:gap-12">
                    ...
                    <div className="w-full max-w-3xl min-w-0 flex-1">
                        <h1 className="mb-8 text-left text-4xl font-bold tracking-tight">Terms of Service</h1>
                        ...
                        <div className="prose prose-slate dark:prose-invert max-w-none">
                            ...
                            <div className="my-12 space-y-12 sm:my-16 sm:space-y-16">
                                <section id="terms">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Terms</h2>
                                ...
                                <section id="use-license">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Use License</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="user-contributions">
                                    <h2 className="!mt-0 text-left text-lg font-bold">User Contributions</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="disclaimer">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Disclaimer</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="limitations">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Limitations</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="accuracy">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Accuracy of Materials</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="links">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Links</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="modifications">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Modifications</h2>
                                    <p className="mt-2 text-left">
                                ...
                                <section id="governing-law">
                                    <h2 className="!mt-0 text-left text-lg font-bold">Governing Law</h2>
                                    <p className="mt-2 text-left">
